...
describe('gulp-angular generator', function () {
  ...
  '\n    with other prompts: [gettext]', function () {
    ...
    it('should pass gulp gettext', function () {
      return this.run(100000, 'gettext').should.be.fulfilled.then(function () {
        assert.ok(fs.statSync(tempDirTmp + '/serve/app/gettext/gettext.catalog.js').isFile(), 'File not exist');
      });
    });
